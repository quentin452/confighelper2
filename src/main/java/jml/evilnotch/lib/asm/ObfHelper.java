...
public class ObfHelper {
    ...
    public static final boolean isDeob = ReflectionHandler
        .getBoolean(ReflectionHandler.getField(CoreModManager.class, "deobfuscatedEnvironment"), null);
    ...
    public static String toDeobfClassName(String obfClassName) {
        if (!isObf) return forceToDeobfClassName(obfClassName);
        else return obfClassName.replace('.', '/');
    }
    ...
    public static String toObfClassName(String deobfClassName) {
        if (isObf) return forceToObfClassName(deobfClassName);
        else return deobfClassName.replace('.', '/');
    }
