...
public class JSONObject extends LinkedHashMap<String, Object> implements IGsonable {
    ...
    /**
     * @param non primitive object arrays are converted into valid json arrays no recursion this converts data into one
     *            JSONArray
     */
    ...
    public void fromGson(JsonElement init) {
        Set<Map.Entry<String, JsonElement>> map = init.getAsJsonObject()
            .entrySet();
