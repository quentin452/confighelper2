...
public final class JSONUtil {
    ...
    public static Object toJSONValue(Object value) {
        if (JavaUtil.isStaticArray(value))
            ...
            || value instanceof Collection && !(value instanceof JSONArray))
            throw new IllegalArgumentException(
                "Inserted Maps must be JSONObject and Inserted Collections Must be JSONArray");
    ...
    public static JsonElement newGsonPrimitive(Object value) {
        ...
        else if (value instanceof String) return new JsonPrimitive((String) value);
        return null;
    }
}
