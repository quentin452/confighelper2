...
public class IdsTransformer implements ITransformer {
    ...
    public static final List<String> clazzes = RegistryIds.asList(
        new String[] { "net.minecraft.world.biome.BiomeGenBase", "net.minecraft.potion.Potion",
            "net.minecraft.enchantment.Enchantment", "net.minecraft.entity.EntityList",
            "net.minecraft.entity.DataWatcher", "net.minecraft.client.network.NetHandlerPlayClient",
            "net.minecraft.network.play.server.S1DPacketEntityEffect",
            "net.minecraft.network.play.server.S1EPacketRemoveEntityEffect", "net.minecraft.potion.PotionEffect",
            "net.minecraft.network.play.server.S0FPacketSpawnMob", "net.minecraft.item.ItemStack" });
    ...
    private void patchItemStack(ClassNode node) {
        ...
        MethodNode write = ASMHelper.getMethod(
            node,
            new MCPSidedString("writeToNBT", "func_77955_b").toString(),
            "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/nbt/NBTTagCompound;");
        MethodInsnNode m1 = ASMHelper.firstMethodInsn(
            write,
            new MethodInsnNode(
                ...
                false));
        MethodInsnNode m2 = ASMHelper.nextMethodInsn(
            m1,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/nbt/NBTTagCompound",
                ...
                false));
        MethodInsnNode m3 = ASMHelper.nextMethodInsn(
            m2,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/nbt/NBTTagCompound",
        ...
        MethodNode read = ASMHelper.getMethod(
            node,
            new MCPSidedString("readFromNBT", "func_77963_c").toString(),
            "(Lnet/minecraft/nbt/NBTTagCompound;)V");
        MethodInsnNode m4 = ASMHelper.firstMethodInsn(
            read,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/nbt/NBTTagCompound",
                ...
                "(Ljava/lang/String;)S",
                false));
        MethodInsnNode m5 = ASMHelper.nextMethodInsn(
            m4,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/nbt/NBTTagCompound",
                ...
                "(Ljava/lang/String;)B",
                false));
        MethodInsnNode m6 = ASMHelper.nextMethodInsn(
            m5,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/nbt/NBTTagCompound",
    ...
    private void patchS0FPacketSpawnMob(ClassNode node) {
        ...
        MethodNode write = ASMHelper.getMethod(
            node,
            new MCPSidedString("writePacketData", "func_148840_b").toString(),
            "(Lnet/minecraft/network/PacketBuffer;)V");
        MethodInsnNode m1 = (MethodInsnNode) ASMHelper.firstMethodInsn(
            write,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/network/PacketBuffer",
                new MCPSidedString("writeByte", "writeByte").toString(),
        ...
        MethodNode read = ASMHelper.getMethod(
            node,
            new MCPSidedString("readPacketData", "func_148837_a").toString(),
            "(Lnet/minecraft/network/PacketBuffer;)V");
        AbstractInsnNode bit2 = ASMHelper.firstInsn(read, Opcodes.IAND);
        MethodInsnNode m2 = (MethodInsnNode) bit2.getPrevious()
            .getPrevious();
    ...
    private void patchPotionEffect(ClassNode node) {
        ...
        MethodNode write = ASMHelper.getMethod(
            node,
            new MCPSidedString("writeCustomPotionEffectToNBT", "func_82719_a").toString(),
            "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/nbt/NBTTagCompound;");
        String setInt = new MCPSidedString("setInteger", "func_74768_a").toString();
        String getInt = new MCPSidedString("getInteger", "func_74762_e").toString();
        String getByte = new MCPSidedString("getByte", "func_74771_c").toString();
        ...
        MethodNode read = ASMHelper.getMethod(
            node,
            new MCPSidedString("readCustomPotionEffectFromNBT", "func_82722_b").toString(),
            "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/potion/PotionEffect;");
        MethodInsnNode compare = new MethodInsnNode(
            Opcodes.INVOKEVIRTUAL,
            "net/minecraft/nbt/NBTTagCompound",
            getByte,
            "(Ljava/lang/String;)B",
    ...
    private void patchEntityList(ClassNode node) {
        MethodNode addMapping = ASMHelper.getMethod(
            node,
            new MCPSidedString("addMapping", "func_75618_a").toString(),
    ...
    private void patchEnchantment(ClassNode node) {
        ...
        AbstractInsnNode spot = ASMHelper
            .firstFieldInsn(
                clinit,
                new FieldInsnNode(
                    Opcodes.PUTSTATIC,
                    "net/minecraft/enchantment/Enchantment",
                    new MCPSidedString("enchantmentsList", "field_77331_b").toString(),
        ...
        AbstractInsnNode spot = ASMHelper
            .firstFieldInsn(
                ...
                new FieldInsnNode(
                    ...
                    new MCPSidedString("potionTypes", "field_76425_a").toString(),
    ...
    private void patchDatawatcher(ClassNode node) {
        ...
        String input = ASMHelper.getInputStream(ModReference.MODID, "DataWatcher"); // "assets/confighelper/asm/" +
                                                                                    // (ObfHelper.isObf ? "srg/" :
                                                                                    // "deob/") + "DataWatcher";
        ASMHelper.replaceMethod(
            node,
            input,
            new MCPSidedString("writeWatchableObjectToPacketBuffer", "func_151510_a").toString(),
            "(Lnet/minecraft/network/PacketBuffer;Lnet/minecraft/entity/DataWatcher$WatchableObject;)V");
        ASMHelper.replaceMethod(
            node,
            input,
            new MCPSidedString("readWatchedListFromPacketBuffer", "func_151508_b").toString(),
            "(Lnet/minecraft/network/PacketBuffer;)Ljava/util/List;");
    }

    private void patchWatcherWriteFull(ClassNode node) {
        MethodNode func = ASMHelper.getMethod(
            node,
            new MCPSidedString("func_151509_a", "func_151509_a").toString(),
            "(Lnet/minecraft/network/PacketBuffer;)V");
        ...
        list2.add(
            new FieldInsnNode(
                ...
                new MCPSidedString("watchedObjects", "field_75695_b").toString(),
                "Ljava/util/Map;"));
        ...
        list2.add(
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/network/PacketBuffer",
                new MCPSidedString("writeVarIntToBuffer", "func_150787_b").toString(),
                "(I)V",
                false));
        AbstractInsnNode index = ASMHelper.firstMethodInsn(
            func,
            new MethodInsnNode(Opcodes.INVOKEINTERFACE, "java/util/concurrent/locks/Lock", "lock", "()V", true));
        func.instructions.insert(index, list2);
        // delete line: buf.writeByte(127);
        AbstractInsnNode point = ASMHelper.lastMethodInsn(
            func,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/network/PacketBuffer",
    ...
    private void patchWatcherWrite(ClassNode node) {
        MethodNode write = ASMHelper.getMethod(
            node,
            new MCPSidedString("writeWatchedListToPacketBuffer", "func_151507_a").toString(),
        ...
        // delete line buf.writeByte(127)
        AbstractInsnNode point2 = ASMHelper.lastMethodInsn(
            write,
            new MethodInsnNode(
                Opcodes.INVOKEVIRTUAL,
                "net/minecraft/network/PacketBuffer",
    ...
    private void patchWatcherAdd(ClassNode node) {
        MethodNode addObject = ASMHelper
            .getMethod(node, new MCPSidedString("addObject", "func_75682_a").toString(), "(ILjava/lang/Object;)V");

        // delete line Integer integer = (Integer) dataTypes.get(obj.getClass());
        AbstractInsnNode start = ASMHelper.firstFieldInsn(
            addObject,
            new FieldInsnNode(
                Opcodes.GETSTATIC,
                "net/minecraft/entity/DataWatcher",
                new MCPSidedString("dataTypes", "field_75697_a").toString(),
                "Ljava/util/HashMap;"));
        ...
        list.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "getWatcherTypeId",
        ...
        append
            .add(new MethodInsnNode(Opcodes.INVOKESTATIC, "jml/evilnotch/lib/asm/ASMHelper", "isFalse", "()Z", false));
    ...
    private void patchNetHandlerPlayClient(ClassNode node) {
        MethodNode method = ASMHelper.getMethod(
            node,
            new MCPSidedString("handleEntityEffect", "func_147260_a").toString(),
