...
public class RegTransformer implements ITransformer {
    ...
    public static final List<String> clazzes = RegistryIds.asList(
        new String[] { "net.minecraft.world.biome.BiomeGenBase", "net.minecraft.potion.Potion",
            "net.minecraft.enchantment.Enchantment", "net.minecraftforge.common.DimensionManager",
            "net.minecraft.entity.EntityList", "net.minecraft.entity.DataWatcher",
    ...
    private static void patchForgeEntityReg(ClassNode classNode) {
        ...
        MethodNode reg = ASMHelper
            .getMethod(classNode, "registerGlobalEntityID", "(Ljava/lang/Class;Ljava/lang/String;III)V");
        AbstractInsnNode spot = ASMHelper.lastMethodInsn(
            reg,
            new MethodInsnNode(
    ...
    private static void patchBiome(ClassNode classNode) {
        ...
        list.add(
            new MethodInsnNode(
                ...
                "registerBiome",
                "(Lnet/minecraft/world/biome/BiomeGenBase;IZ)I",
                false));
        list.add(new VarInsnNode(Opcodes.ISTORE, 1));
        FieldInsnNode field = new FieldInsnNode(
            Opcodes.PUTFIELD,
            "net/minecraft/world/biome/BiomeGenBase",
            new MCPSidedString("topBlock", "field_76752_A").toString(),
        ...
        list2.add(
            new MethodInsnNode(Opcodes.INVOKESTATIC, "jml/confighelper/reg/Registries", "regBiomes", "()V", false));
    ...
    private static void patchPotion(ClassNode classNode) {
        ...
        list.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "registerPotion",
                "(Lnet/minecraft/potion/Potion;I)I",
                false));
        list.add(new VarInsnNode(Opcodes.ISTORE, 1));
    ...
    private void patchEnchantment(ClassNode classNode) {
        ...
        list.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "registerEnchantment",
                "(Lnet/minecraft/enchantment/Enchantment;I)I",
                false));
        list.add(new VarInsnNode(Opcodes.ISTORE, 1));
        node.instructions.insert(ASMHelper.firstInsn(node, Opcodes.INVOKESPECIAL), list);
    }
    ...
    private static void optimizeDims(ClassNode node) {
        ...
        AbstractInsnNode a = ASMHelper.lastFieldInsn(
            dimensions,
            new FieldInsnNode(
                Opcodes.GETSTATIC,
                ...
                "Ljava/util/BitSet;"));
        if (a != null) {
            AbstractInsnNode end = ASMHelper
                .nextMethodInsn(a, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/BitSet", "set", "(I)V", false));
        ...
        for (AbstractInsnNode ab : clinit.instructions.toArray()) {
            if (ab.getOpcode() == Opcodes.NEW) {
                ...
                if (start.desc.equals("java/util/BitSet")) {
                    AbstractInsnNode end = ASMHelper.nextFieldInsn(
                        start,
                        new FieldInsnNode(
                            Opcodes.PUTSTATIC,
                            "net/minecraftforge/common/DimensionManager",
    ...
    private void patchEntityList(ClassNode classNode) {
        ...
        MethodNode node = ASMHelper.getMethod(
            classNode,
        ...
        list.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "registerEntity",
                "(Ljava/lang/Class;Ljava/lang/String;I)I",
                false));
        list.add(new VarInsnNode(Opcodes.ISTORE, 2));
        node.instructions.insert(ASMHelper.firstInsn(node), list);

        // inject line: id = (Integer) classToIDMapping.get(id);
        MethodNode egg = ASMHelper.getMethod(
            classNode,
            new MCPSidedString("addMapping", "func_75614_a").toString(),
        ...
        list2.add(
            new FieldInsnNode(
                ...
                new MCPSidedString("classToIDMapping", "field_75624_e").toString(),
                "Ljava/util/Map;"));
    ...
    private void patchDatawatcher(ClassNode classNode) {
        ...
        list0.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "createWatcherReg",
                "(Lnet/minecraft/entity/Entity;)Ljml/confighelper/reg/Registry;",
                false));
        list0.add(
            new FieldInsnNode(
                Opcodes.PUTFIELD,
                ...
                "reg",
                "Ljml/confighelper/reg/Registry;"));
        construct.instructions.insert(ASMHelper.lastPutField(construct), list0);

        MethodNode addObject = ASMHelper
            .getMethod(classNode, new MCPSidedString("addObject", "func_75682_a").toString(), "(ILjava/lang/Object;)V");
        ...
        list2.add(
            new FieldInsnNode(
                Opcodes.GETFIELD,
                "net/minecraft/entity/DataWatcher",
                new MCPSidedString("field_151511_a", "field_151511_a").toString(),
        ...
        list2.add(
            new MethodInsnNode(
                ...
                "jml/confighelper/reg/Registries",
                "registerDataWatcher",
                "(Lnet/minecraft/entity/Entity;ILjml/confighelper/reg/Registry;)I",
                false));
        list2.add(new VarInsnNode(Opcodes.ISTORE, 1));
