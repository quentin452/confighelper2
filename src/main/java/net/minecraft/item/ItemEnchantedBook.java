...
public class ItemEnchantedBook extends Item {
    ...
    public EnumRarity getRarity(ItemStack p_77613_1_) {
        return this.func_92110_g(p_77613_1_)
            .tagCount() > 0 ? EnumRarity.uncommon : super.getRarity(p_77613_1_);
    }

    public NBTTagList func_92110_g(ItemStack p_92110_1_) {
        return p_92110_1_.stackTagCompound != null && p_92110_1_.stackTagCompound.hasKey("StoredEnchantments", 9)
        ...
        if (nbttaglist != null) {
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                ...
                if (Enchantment.enchantmentsList[id] != null) {
                    p_77624_3_.add(Enchantment.enchantmentsList[id].getTranslatedName(lvl));
                }
            }
        }
    }
    ...
    public void addEnchantment(ItemStack p_92115_1_, EnchantmentData p_92115_2_) {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
            ...
            if (nbttagcompound.getInteger("id") == p_92115_2_.enchantmentobj.effectId) {
                if (nbttagcompound.getInteger("lvl") < p_92115_2_.enchantmentLevel) {
                    nbttagcompound.setInteger("lvl", p_92115_2_.enchantmentLevel);
                }
        ...
        if (flag) {
            ...
            nbttagcompound1.setInteger("id", p_92115_2_.enchantmentobj.effectId);
            nbttagcompound1.setInteger("lvl", p_92115_2_.enchantmentLevel);
