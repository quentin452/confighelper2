...
public final class ItemStack {
    ...
    public boolean tryPlaceItemIntoWorld(EntityPlayer p_77943_1_, World p_77943_2_, int p_77943_3_, int p_77943_4_,
        ...
        if (!p_77943_2_.isRemote) return net.minecraftforge.common.ForgeHooks.onPlaceItemIntoWorld(
            this,
            p_77943_1_,
            p_77943_2_,
            p_77943_3_,
    ...
    public float func_150997_a(Block p_150997_1_) {
        return this.getItem()
            .func_150893_a(this, p_150997_1_);
    }
    ...
    public ItemStack useItemRightClick(World p_77957_1_, EntityPlayer p_77957_2_) {
        return this.getItem()
            .onItemRightClick(this, p_77957_1_, p_77957_2_);
    }

    public ItemStack onFoodEaten(World p_77950_1_, EntityPlayer p_77950_2_) {
        return this.getItem()
            .onEaten(this, p_77950_1_, p_77950_2_);
    }
    ...
    public boolean isItemStackDamageable() {
        return this.field_151002_e.getMaxDamage(this) <= 0 ? false
            : !this.hasTagCompound() || !this.getTagCompound()
    ...
    public void func_150999_a(World p_150999_1_, Block p_150999_2_, int p_150999_3_, int p_150999_4_, int p_150999_5_,
        ...
        boolean flag = this.field_151002_e
            .onBlockDestroyed(this, p_150999_1_, p_150999_2_, p_150999_3_, p_150999_4_, p_150999_5_, p_150999_6_);
    ...
    public ItemStack setStackDisplayName(String p_151001_1_) {
        ...
        this.stackTagCompound.getCompoundTag("display")
            .setString("Name", p_151001_1_);
        return this;
    }
    ...
    public List getTooltip(EntityPlayer p_82840_1_, boolean p_82840_2_) {
        ...
        if (p_82840_2_) {
            ...
            if (this.getHasSubtypes()) {
                s = s + String
                    .format("#%04d/%d%s", new Object[] { Integer.valueOf(i), Integer.valueOf(this.itemDamage), s1 });
            } else {
        ...
        if (this.hasTagCompound()) {
            ...
            if (nbttaglist != null) {
                for (i = 0; i < nbttaglist.tagCount(); ++i) {
                    int id = nbttaglist.getCompoundTagAt(i)
                        .getInteger("id");
                    int lvl = nbttaglist.getCompoundTagAt(i)
                        .getInteger("lvl");

                    if (Enchantment.enchantmentsList[id] != null) {
                        arraylist.add(Enchantment.enchantmentsList[id].getTranslatedName(lvl));
                    }
                }
            }
        ...
        if (!multimap.isEmpty()) {
            arraylist.add("");
            Iterator iterator = multimap.entries()
                .iterator();
        ...
        if (p_82840_2_ && this.isItemDamaged()) {
            arraylist.add(
                "Durability: " + (this.getMaxDamage() - this.getItemDamageForDisplay()) + " / " + this.getMaxDamage());
        }
    ...
    public boolean isItemEnchantable() {
        return !this.getItem()
            .isItemTool(this) ? false : !this.isItemEnchanted();
    }
    ...
    public void addEnchantment(Enchantment p_77966_1_, int p_77966_2_) {
        ...
        nbttagcompound.setInteger("id", p_77966_1_.effectId);
        nbttagcompound.setInteger("lvl", p_77966_2_);
    ...
    public IChatComponent func_151000_E() {
        IChatComponent ichatcomponent = (new ChatComponentText("[")).appendText(this.getDisplayName())
            .appendText("]");
        ...
        if (this.field_151002_e != null) {
            ...
            ichatcomponent.getChatStyle()
                .setColor(this.getRarity().rarityColor);
        }
