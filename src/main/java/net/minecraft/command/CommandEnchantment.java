...
public class CommandEnchantment extends CommandBase
{
                ...
                else
                {
                    ...
                    if (itemstack.hasTagCompound())
                    {
                        ...
                        if (nbttaglist != null)
                        {
                            ...
                            {
                                int id = nbttaglist.getCompoundTagAt(k).getInteger("id");

                                if (Enchantment.enchantmentsList[id] != null)
                                {
                                    Enchantment enchantment1 = Enchantment.enchantmentsList[id];
                                    ...
                                    {
                                        throw new CommandException("commands.enchant.cantCombine", new Object[] {enchantment.getTranslatedName(j), enchantment1.getTranslatedName(nbttaglist.getCompoundTagAt(k).getInteger("lvl"))});
                                    }
                                }
                            }
                        }
